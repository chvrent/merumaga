...
function normalizeScheduleRow_(sheetName, rowNumber, headers, row) {
  const record = {
    ...
    sub_category: getFieldByAliases_(headers, row, SCHEDULE_FIELD_ALIASES.sub_category) || normalizeCell_(row[7]),
    ...
    mail_name: getFieldByAliases_(headers, row, SCHEDULE_FIELD_ALIASES.mail_name) || normalizeCell_(row[7]),
